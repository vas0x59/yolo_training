...
cfg[602] = "filters=" + str((len(CLASSES) + 5)*3) + "\n"
cfg[688] = "filters=" + str((len(CLASSES) + 5)*3) + "\n"
cfg[775] = "filters=" + str((len(CLASSES) + 5)*3) + "\n"

cfg[609] = "classes=" + str(len(CLASSES)) + "\n"
cfg[695] = "classes=" + str(len(CLASSES)) + "\n"
cfg[782] = "classes=" + str(len(CLASSES)) + "\n"
